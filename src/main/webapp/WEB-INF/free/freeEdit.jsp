...
$(function(){
	...
	function sendFile(file, el) {
	    ...
	    $.ajax({
			data: form_data,
		    type: "POST",
		    url: '/lingopos/Image/Image.Lingo',
		    cache: false,
		    contentType: false,
...
<!-- 바디 헤더 시작-->
	<div class="row">
		<div class="col-xs-6">
			<h2 ><img src="<c:url value='/Images/apple.png'/>" alt="image" style="width: 40px" />자유게시판<small>게시판 수정</small></h2>
		</div>
	</div>	
<!-- 바디 헤더 끝-->
<!-- 폼 시작 -->
 	<form id="frm" class="form-horizontal" method="post" action='<c:url value="/Free/FreeEdit.Lingo"/>'>
<!-- 제목 시작 -->
