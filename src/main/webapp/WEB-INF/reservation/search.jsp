...
<style>
	    ...
	    .container .row {width: 365px;height: 125px;border-radius: 5px;border-bottom: 2px solid #ccc;border-right: 1px solid #ccc;overflow: hidden;background: #fff;}
	    .container .row:nth-child(1) {border: 0;box-shadow: 0px 1px 2px #888;}
	    .row .title {padding: 5px 0 0 10px;height: 30px;background: #eee;border-bottom: 1px solid #ddd;font-size: 18px;font-weight: bold;white-space: nowrap;}
	    .row .close {position: absolute;top: 10px;right: 10px;color: #888;width: 17px;height: 17px;background: url('http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/overlay_close.png');}
	    .row .close:hover {cursor: pointer;}
	    .row .body {position: relative;overflow: hidden;}
	    .row .desc {position: relative;margin: 13px 20px 10px 90px;height: 75px;}
	...
	<div class="bg_wrap" style="overflow:auto">
		...
		<table>
			<tr id="searchTable" style="height:240px;width:400px;display:inline-block" >
				<td><a href='https://www.naver.com' >네이버 클릭</a></td>
			</tr>
		</table>
	</div>
</div>
