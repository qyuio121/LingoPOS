...
<!-- 바디 헤더 끝-->
<!-- 폼 시작 -->
 	<form id="frm" class="form-horizontal" method="post" action='<c:url value="/Question/QNAWrite.Lingo"/>'>
<!-- 상담분류 시작 -->	
...
<!-- 버튼 3개 시작 - 문의하기 / 취소  -->
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10" >
 			<button type="button" value="button타입" class="btn btn-primary col-sm-offset-4" id="confirm">문의하기</button><!-- 문의하기 -->     
